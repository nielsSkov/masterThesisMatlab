...
\item[4.] Parameter nøjagtighed og følsomhed, Frekvensdomænet
...
\item Enhver model struktur kan anvendes, lineær, ulineær,
...
\item En følsomheds metode brugbar til valg af model struktur,
...
\item \textbf{Neuraltnetværk:} \quad Meget ulineære systemer med en
