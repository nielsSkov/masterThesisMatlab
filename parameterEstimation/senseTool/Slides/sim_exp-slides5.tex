...
\untilSlide*{3}{%
Modelfejlen i tids-domænet ({\red støj ignoreret}): 
...
Modelparametrene kan bestemmes i frekvens-domænet, når der er målt
...
\item[4.] Parameternøjagtighed og følsomhed, Design af inputsignaler
...
\medskip
\item[\red 3.] \textbf{Indtast nødvendige programdata}, dette kan
...
{\blue Parameterafhængigt} bidrag på outputfejlen:
...
\item For lineære systemer var signalklassen firkantsignaler.
...
dvs. bedste fit er i frekvensområdet, hvor effekten i inputsignalet
er høj.
...
(vend opstillingen på hovedet, kør baglæns, luk sløjfen \dots)
